...
const Banner = ({isMobile, darkMode}: {isMobile: boolean, darkMode: boolean}) => {
    return (
        isMobile ? (
            <BannerMobile darkMode={darkMode} />
        ) : (
            <section className="relative overflow-hidden">
                <div className="container mx-auto px-4 pt-12 pb-6 md:pt-24 md:pb-0 flex">
